// Basic Variable Manipulation Exercises
...
const myFruits = ['lemon', 'lime', 'orange'];

// Add a new fruit to the fruits array.

myFruits.push('grapefruit')
...
delete myCarObj.year;

console.log(myCarObj.year);
